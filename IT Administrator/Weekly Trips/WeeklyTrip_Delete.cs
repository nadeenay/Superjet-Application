...
{
    public partial class WeeklyTrip_Delete : UserControl
    {
        Controller controller;
        public WeeklyTrip_Delete()
        {
            InitializeComponent();
        ...
        private void Search_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    list[i].EditButtonVisable = false;
        ...
        private void WeeklyTrip_Search_Panel_Paint(object sender, PaintEventArgs e)
        {
